...
import { getLogger, emptyLogger } from "../../utils/log";
...
function buildContentScriptParameters(): ContentScriptParameters {
	...
	const parameters: ContentScriptParameters = {
		...
		enableLogger: false // This parameter is useless in IE. To enable logs in IE content -
		// add log_1.enableLogs() in the main function of  C:\ProgramData\Aternity\hooks\addon.js
	};
	return parameters;
}
