	...
	try {
		...
		if (parameters.wpmParameters.wpm) {
			...
			if (statusCode >= 400 && statusCode < 600) {
				...
				chrome.runtime.sendMessage(wpmErrorMessage);
				...
				chrome.runtime.sendMessage(wpmPageLoadUXMessage);
			}
		}
		...
		if (parameters.wpmParameters.httpWebPageLoad) {
			...
			chrome.runtime.sendMessage(httpChromeWebPageLoadMessage);
		}
